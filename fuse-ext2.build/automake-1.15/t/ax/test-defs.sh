...
am_rel_srcdir='.'
am_top_srcdir='/Users/hok/Downloads/ext4/fuse-ext2.build/automake-1.15'
am_top_builddir='/Users/hok/Downloads/ext4/fuse-ext2.build/automake-1.15'
...
MKDIR_P=${AM_TESTSUITE_MKDIR_P-'/usr/local/bin/gmkdir -p'}
